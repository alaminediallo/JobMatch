...
-->
<div id="page-container" class="sidebar-o enable-page-overlay sidebar side-scroll page-header-fixed
  main-content-narrow">
    <!-- Side Overlay-->
        ...
        <div class="content py-0">
            <div class="row fs-sm">
                ...
                <div class="col-sm-6 order-sm-1 text-center text-sm-start">
                    <a class="fw-semibold" href="https://pixelcave.com/products/dashmix" target="_blank">JobMatch</a>
                    &copy;
...
<script>
    function devtoolIsOpening() {
        ...
        debugger ;let after = new Date().getTime();
        if (after - before > 200) {
