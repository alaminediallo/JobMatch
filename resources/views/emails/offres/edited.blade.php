...
<div class="email-container">
    ...
    <div class="email-header">
        Offre d'emploi modifiée
    </div>

    <!-- Body -->
    <div class="email-content">
        Une offre d'emploi a été modifiée et nécessite une nouvelle validation.
    </div>
    ...
    <div class="email-content" style="padding-top: 0;">
        ...
        <p>Vous pouvez examiner l'offre en cliquant sur le lien ci-dessous :</p>
    </div>

    <!-- Button -->
    <div class="email-button">
        <a href="{{ route('offre.show', $offre) }}">Examiner l'offre</a>
    </div>
