                        ...
                        <form class="d-flex align-items-center" action="#" method="POST"
                            ...
                            <div class="flex-grow-1">
                                ...
                                <input type="text" class="form-control form-control-lg form-control-alt"
                                       id="example-job-search" name="example-job-search" placeholder="Search Jobs..">
                            </div>
    ...
    <div class="content content-boxed content-full">
        ...
        <div class="row items-push">
            <div class="col-md-6 col-xl-3">
                <a class="block block-rounded block-link-shadow d-flex justify-content-center align-items-start text-center bg-xpro h-100 mb-0"
            ...
            <div class="col-md-6 col-xl-3">
                <a class="block block-rounded block-link-shadow d-flex justify-content-center align-items-start text-center bg-xinspire h-100 mb-0"
                   href="javascript:void(0)">
                    <div class="block-content block-content-full bg-body-extra-light mt-1 align-self-stretch">
                        <div class="py-4">
            ...
            <div class="col-md-6 col-xl-3">
                <a class="block block-rounded block-link-shadow d-flex justify-content-center align-items-start text-center bg-xsmooth h-100 mb-0"
                   href="javascript:void(0)">
                    <div class="block-content block-content-full bg-body-extra-light mt-1 align-self-stretch">
                        <div class="py-4">
            ...
            <div class="col-md-6 col-xl-3">
                <a class="block block-rounded block-link-shadow d-flex justify-content-center align-items-start text-center bg-xplay h-100 mb-0"
                   href="javascript:void(0)">
                    ...
                    <td>
                        <div class="d-sm-flex">
                            <div class="ms-sm-2 me-sm-4 py-3">
                                <a class="item item-rounded bg-body-dark text-dark fs-2 mb-2 mx-auto"
                                   href="javascript:void(0)">
                            ...
                            <div class="py-3">
                                <a class="link-fx h4 mb-1 d-inline-block text-dark" href="#">
                                    React Developer
                                </a>
                                ...
                                <p class="text-muted mb-2">
                                    Ac cursus nibh sapien in purus. Mauris tincidunt tincidunt turpis in porta. Integer
                                    fermentum tincidunt auctor. Vestibulum ullamcorper, odio sed rhoncus imperdiet, enim
                                    elit sollicitudin orci, ege.
                                </p>
                                <div>
